...
<div class="bg">
    ...
    <main role="main">
        ...
        <div class="exchange_div">
            <div id="dq_1">
                <div class="bar">
                    <p><a href="../main_page/"><img src="../../image/home.png"> </a><a href="../data_query/">数据查询</a><a>历史数据</a></p>
                    <ul>
                ...
                <div class="content">
                    <div class="dq_div1">
                        ...
                        <ul class="data_query_ul2">
                            ...
                            <li class="day_report_s">
                                <label>日：</label>
                                <input class="laydate-icon" onclick="laydate()" id="day_time_start">
                            </li>
                            <li class="day_report_e">
                                <label>至</label>
                                <input class="laydate-icon" onclick="laydate()" id="day_time_end">
                            </li>
                            <li class="hour_report">
                                <label>时：</label>
                                <input >
                            </li>
                            <input class="btn" value="查询" readonly="true">
                        </ul>
                    </div>
                    <div class="dq_div2">
                        <div class="menu_bar"><img src="../../image/dq_2.png">资源消耗曲线</div>
                    </div>
                    <div class="dq_div4">
                    ...
                    <div class="dq_div3">
                        <div class="menu_bar"><img src="../../image/dq_3.png">资源消耗表
                            <ul class="right">
                                <li><a class="active" id="export_report">导出报表</a> </li>
