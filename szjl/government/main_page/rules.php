...
<div class="bg">
    ...
    <main role="main">
        ...
        <div class="exchange_div">
            <div id="mp_3">
                <div class="bar">
                    <p><a href="../main_page/"><img src="../../image/home.png"> </a><a href="../main_page/">首页</a><a>政策法规</a></p>
                </div>
                <div class="content">
                    <br/>
                    <div id="mp3_page1">
                        <table class="tab">
                            <tr>
                                ...
                                <td><a target="_blank" href="policies/GB 17167-2006.pdf">【下载】</a></td>
                            </tr>
                            <tr>
                                <td>中华人民共和国节约能源法</td>
                                <td><a target="_blank" href="policies/China energy conservation law (Presidential Decree No. seventy-seventh).html">【下载】</a></td>
                            </tr>
                            <tr>
                                <td>GB 24789-2009 用水单位水计量器具配备和管理通则</td>
                                <td><a target="_blank" href="policies/GB 24789-2009.pdf">【下载】</a></td>
                            </tr>
                            <tr>
                                <td>能源计量监督管理办法</td>
                                <td><a target="_blank" href="policies/Energy Metering Supervision and Administration.html">【下载】</a></td>
                            </tr>
                            <tr>
                                <td>国务院关于印发十二五节能减排综合性工作方案的通知</td>
                                <td><a target="_blank" href="policies/The people's Republic of China energy conservation law.html">【下载】</a></td>
                            </tr>
                            <tr>
                                <td>国务院关于印发十二五控制温室气体排放工作方案的通知</td>
                                <td><a target="_blank" href="policies/Circular of the State Council issued on the Twelfth Five Year work.html">【下载】</a></td>
                            </tr>
                            <tr>
                                <td>发改环资[2011]2873号关于印发万家企业节能低碳行动实施方案的通知</td>
                                <td><a target="_blank" href="policies/Million businesses on the issuance of low-carbon energy.html">【下载】</a></td>
                            </tr>
                            <tr>
                                <td>JJF重点用能单位能源计量审查规范-辅导</td>
                                <td><a target="_blank" href="policies/JJF.pdf">【下载】</a></td>
                            </tr>
                            <tr>
                                <td>国务院关于印发计量发展规划（2013-2020年）的通知</td>
                                <td><a target="_blank" href="policies/Of the State Council on the development plan of issuing measurement (2013-2020) Notice.html">【下载】</a></td>
                            </tr>
                        </table>
                    </div>
                </div>
