 ...
 */
function xiangchengqu1(map, cityName) {
    var point = new BMap.Point(120.642903,31.452147);
    ...
    bdary.get(cityName, function (rs) {       //获取行政区域
        ...
        var ply2 = new BMap.Polygon([new BMap.Point(120.543262,31.419024),new BMap.Point(120.555631,31.42234),new BMap.Point(120.543297,31.337364)],{
            strokeColor: "none",
            fillColor:"rgb(79,79,79)",
            strokeOpacity: 1
        });
        map.addOverlay(ply2);
        var ply3 = new BMap.Polygon([new BMap.Point(120.543275,31.337279),new BMap.Point(120.555631,0.000017),new BMap.Point(112.61545,-29.562711)],{
            strokeColor: "none",
            fillColor:"rgb(79,79,79)",
            strokeOpacity: 1
        });
