 ...
 */
function changshu1(map, cityName) {
    var point = new BMap.Point(120.828601,31.685231);    // 创建点坐标  112.987402, 28.201509
    ...
    bdary.get(cityName, function (rs) {       //获取行政区域
        ...
        //4.自定义外围边框点的集合
        var E_JW = "170.672126, 38.623555;";            //东
        var EN_JW = "170.672126, 81.291804;";       //东北角
        var N_JW = "110.913641, 81.291804;";        //北
        var NW_JW = "-169.604276,  81.291804;";     //西北角
        var W_JW = "-169.604276, 38.244136;";       //西
        var WS_JW = "-169.604276, -68.045308;";     //西南角
        var S_JW = "105.15563, -68.045308;";            //南
        var SE_JW = "170.672126, -68.045308;";         //东南角
        //4.添加环形遮罩层
        var ply1 = new BMap.Polygon(rs.boundaries[0]+S_JW+E_JW+N_JW+S_JW, {
            strokeColor: "none",
            fillColor: "rgb(79,79,79)",
            strokeOpacity: 1
        }); //建立多边形覆盖物
        map.addOverlay(ply1);  //遮罩物是半透明的，如果需要纯色可以多添加几层
        var ply2 = new BMap.Polygon([new BMap.Point(120.742211,31.542298),new BMap.Point(120.75648,31.536954),new BMap.Point(120.74226,31.440261)],{
            strokeColor:"none",
            fillColor:"rgb(79,79,79)",
            strokeOpacity:1
        });
        map.addOverlay(ply2);
        var ply3 = new BMap.Polygon([new BMap.Point(120.74226,31.440261),new BMap.Point(116.464102,-1.01736),new BMap.Point(120.756494,0.000012)],{
            strokeColor:"none",
            fillColor:"rgb(79,79,79)",
            strokeOpacity:1
        });
