...
$tsn = $row['tsn'];
$updateLimit = "update `t_tech_limit_fill` set `water_last_limit_value`='{$water_last_limit_value}',`water_last_limit_value_unit`='{$water_last_limit_value_unit}',`last_limit_value`='{$last_limit_value}',`last_limit_value_unit`='{$last_limit_value_unit}',`water_if_beyond`='{$water_if_beyond}',`if_beyond`='{$if_beyond}',`limit_select`='{$select_state}',`audit_state`='通过审核' where `enter_tsn`='{$tsn}' and `Crt_date`='{$date}'";
