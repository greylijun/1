...
<div class="bg">
    ...
    <main role="main">
        <div class="menu">
            <ul>
                <li><a href="../index.php">意见交流</a></li>
                <li class="on"><a href="../history/index.php">历史意见</a></li>
            </ul>
        </div>
        <div class="exchange_div">
            <div class="bar">
                <p><a href="../../main_page/inform.php"><img src="../../../image/home.png"> </a><a href="../index.php">意见交流</a><a>历史意见</a></p>
            </div>
            <div class="content">
