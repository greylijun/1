...
class UpLoad{
    ...
    function submitFile(){
        ...
        $path1 = "../../../upload_file/plan/".$enter_tsn1."/".$date_time;
        ...
        if(move_uploaded_file($_FILES[$this->File]["tmp_name"],$filepath1)){
            ...
            $sql = $conn->query("update `t_energy_saving_measures_plan` set `technical_renovation_content` = '".$filepath."' where `enter_tsn`='".$enter_tsn1."' and `project_name`='{$project_name}'");
            if($sql){
                echo "UploadSuccess";
