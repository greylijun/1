...
if($table_two_type != "全部"){
    $sql .= " and `energy_big_type` = '{$table_one_type}' and `path_number`='{$table_two_type}' and `table_grade`='2'";
}else{
    $sql .= " and `energy_big_type` = '{$table_one_type}' and `table_grade`='2'";
}
...
if($table_two_type != "全部"){
    $sqlForIndiff .= " and `energy_big_type` = '{$table_one_type}' and `path_number`='{$table_two_type}' and `table_grade`='2'";
}else{
    $sqlForIndiff .= " and `energy_big_type` = '{$table_one_type}' and `table_grade`='2'";
}
